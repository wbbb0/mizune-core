...
async function main() {
  await runCase("chat file image content exposes one-week cache headers and 304 responses", async () => {
  ...
  await runCase("local sendable image content exposes one-week cache headers and 304 responses", async () => {
  ...
  await runCase("local workspace image content exposes one-week cache headers and 304 responses", async () => {
    const deps = createInternalApiDeps();
    deps.localFileService = {
      ...deps.localFileService,
