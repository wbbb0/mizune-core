...
test("transcript disclosure renders a single expandable card with scrollable body", async () => {
  const source = await readFile(
    new URL("../../../webui/src/components/sessions/TranscriptDisclosure.vue", import.meta.url),
    "utf8"
  );
