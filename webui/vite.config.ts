...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@workbench-kit/vue/theme/midnight.css": resolve(configDir, "../vendor/workbench-kit/packages/vue/src/themes/midnight.css"),
      "@workbench-kit/vue/style.css": resolve(configDir, "../vendor/workbench-kit/packages/vue/src/style.css"),
      "@workbench-kit/vue/runtime": resolve(configDir, "../vendor/workbench-kit/packages/vue/src/runtime.ts"),
      "@workbench-kit/vue": resolve(configDir, "../vendor/workbench-kit/packages/vue/src/index.ts"),
