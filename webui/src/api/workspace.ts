...
import type { FileWorkspaceClient, LocalFileItem, LocalFileListResult, LocalFilePreview } from "@workbench-kit/vue";

export type { FileWorkspaceClient, LocalFileItem, LocalFileListResult, LocalFilePreview } from "@workbench-kit/vue";
